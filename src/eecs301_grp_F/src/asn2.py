...
if __name__ == "__main__":
    ...
    mStartTuple = literal_eval(raw_input("What is starting cell? (tuple) "))
    mStartHeading = (raw_input("what is your start heading? (north, south, east, west)"))
    
    myMap = keepRightWalk(mStartTuple, mStartHeading)
    setMapInf(myMap)
