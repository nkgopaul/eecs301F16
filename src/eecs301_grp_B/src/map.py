...
class EECSMap():
    def __init__(self):
        ...
        self.verticalWalls[6][2] = 1
        self.verticalWalls[6][3] = 1
        self.verticalWalls[6][4] = 1
        self.verticalWalls[6][5] = 1
        self.verticalWalls[6][6] = 1
        self.verticalWalls[6][7] = 1
        self.verticalWalls[6][8] = 1
        self.verticalWalls[7][0] = 1
        self.verticalWalls[7][1] = 1
        self.verticalWalls[7][2] = 1
        self.verticalWalls[7][3] = 1
        self.verticalWalls[7][4] = 1
        self.verticalWalls[7][5] = 1
        self.verticalWalls[7][6] = 1
